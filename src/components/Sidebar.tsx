...
import { LayoutDashboard, Settings, PieChart, BarChart2, Bell, Lock, CalendarDays, Dices, Inbox, Store, Megaphone, Instagram } from 'lucide-react';
import {
    ...
    <aside className="sidebar glass-panel">
      ...
      <nav className="sidebar-nav">
        <ul className="nav-list">
          ...
          <li className="nav-item">
            <NavLink to="/instagram" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <Instagram size={20} />
              <span>Instagram</span>
            </NavLink>
          </li>
